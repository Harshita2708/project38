...
var pinkCG, yellowCG,redCG, obstacles; 
...
// Moving background
path=createSprite(1000,300);
path.addImage(pathImg);
path.velocityX = -5;

//creating boy running
mainCyclist  = createSprite(170,150);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
     ...
     text("press q to restart ",300,200 );
    }
    ...
    gameOver.visible = true;
     textSize(50);
    fill("lightblue");
    text("Press Up Arrow to Restart the game!", 290,displayWidth/3.5)
